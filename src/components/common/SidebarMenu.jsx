                            ...
                            <div className="sidebar-menu-wrap">
                                <ul className="main-menu">
                                    ...
                                    <li>
                                        ...
                                        <span className={`dropdown-icon2 ${state.activeMenu === "solution" ? "active" : ""} `}><i className={`bi ${state.activeMenu === "solution" ? "bi-dash" : "bi-plus"}`} onClick={() => collapseMenu("solution")} /></span>
                                    ...
                                    <li>
                                        ...
                                        <span className={`dropdown-icon2 ${state.activeMenu === "project" ? "active" : ""} `}><i className={`bi ${state.activeMenu === "project" ? "bi-dash" : "bi-plus"}`} onClick={() => collapseMenu("project")} /></span>
                                    ...
                                    <li>
                                        <a href="#">Pages</a>
                                        <span className={`dropdown-icon2 ${state.activeMenu === "pages" ? "active" : ""} `}><i className={`bi ${state.activeMenu === "pages" ? "bi-dash" : "bi-plus"}`} onClick={() => collapseMenu("pages")} /></span>
                                        <ul className={`submenu-list ${state.activeMenu === "pages" ? "active" : ""}`}>
                                            ...
                                            <li>
                                                ...
                                                <span className="dropdown-icon2 two"><i className={`bi ${state.activeSubMenu === "properties" ? "bi-dash" : "bi-plus"}`} onClick={() => toggleSubMenu("properties")} /></span>
                                            ...
                                            <li>
                                                ...
                                                <span className="dropdown-icon2 two"><i className={`bi ${state.activeSubMenu === "shop" ? "bi-dash" : "bi-plus"}`} onClick={() => toggleSubMenu("shop")} /></span>
