...
const Header1: React.FC<Header1Props> = ({ style = "", fluid }) => {
    ...
    const saveUserToDatabase = async () => {
        if (user && !isRegistered) {
            try {
                // Add detailed user info to help with debugging
                ...
                const response = await fetch('/api/user', {
                    ...
                    body: JSON.stringify({ 
                        userId: user.id,
                        // Optional: You could send additional data if needed
                        // email: user.email?.address, 
                    }),
                    headers: {
    ...
    useEffect(() => {
        ...
        if (authenticated && user) {
            console.log('User data from Privy:', user);
    
    // Check if user has an email
    if (!user.email?.address) {
      console.log('User authenticated without email');
    }
    
            saveUserToDatabase();
        }
    }, [authenticated, user]);  // Add these dependencies
    ...
    const selectLanguage = (language: string) => {
        ...
        setIsActive(false); // Close the dropdown after selecting a language
    };

    const handleClickOutside = (event: MouseEvent) => {
        if (dropdownRef.current && !dropdownRef.current.contains(event.target as Node)) {
            setIsActive(false); // Close the dropdown if clicking outside
        }
    };
    ...
    // Function to handle account button action based on authentication status
        ...
        <>
                        ...
                        <div className="topbar-right">
                            <div className="language-area">
                                ...
                                <ul className={`language-list ${isActive ? "active" : ""}`}>
                                    {["English", "Deutsch", "Svenska", "اردو", "عربي", "Nederlands"].map(
                                        (language, index) => (
                                            <li key={index}>
                                                <a href="#" onClick={() => selectLanguage(language)}>
                                                    {language}
                                                </a>
                                            </li>
                                        )
            ...
            <header className="header-area style-1">
                <div className="container d-flex flex-nowrap align-items-center justify-content-between">
                    <div className="header-logo d-lg-none d-block">
                        <Link href="/">
                            <img alt="image" className="img-fluid light" src="/assets/img/header-logo.svg" />
                            <img alt="image" className="img-fluid dark" src="/assets/img/header-logo-white.svg" />
                        </Link>
                    ...
                    <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
                        ...
                        <ul className="menu-list">
                            <li className={`menu-item-has-children ${pathname === "/" ? "active" : ""}`} onClick={() => toggleMenu("home")}>
                                <a href="#" className="drop-down">Home</a>
                                <i className={`bi bi-${state.activeMenu === "home" ? "dash" : "plus"} dropdown-icon"`} />
                                <ul className={`sub-menu two ${state.activeMenu === "home" ? "d-block" : ""} `}>
                                    <li className={pathname === "/" ? "active" : ""}><Link href="/">Home 1</Link></li>
                                    <li className={pathname === "/index2" ? "active" : ""}><Link href="/index2" >Home 2</Link></li>
                                </ul>
                            </li>
                            <li className="menu-item-has-children" onClick={() => toggleMenu("artist")}>
                                <a href="#" className="drop-down">Artists Portfolio</a>
                                <i className={`bi bi-${state.activeMenu === "artist" ? "dash" : "plus"} dropdown-icon"`} />
                                <div className={`mega-menu ${state.activeMenu === "artist" ? "d-block" : ""}`}>
                                    <ul className="menu-row">
                                        <li>
                                            <Link href="/artists/portfolio" className="artists-img">
                                                <img src="/assets/img/home1/menu-artists-img1.png" alt="" />
                                            </Link>
                                        ...
                                        <li>
                                            <Link href="/artists/portfolio" className="artists-img">
                                                <img src="/assets/img/home1/menu-artists-img2.png" alt="" />
                                            </Link>
                                            <div className="artists-content">
                                        ...
                                        <li>
                                            <Link href="/artists/portfolio" className="artists-img">
                                                <img src="/assets/img/home1/menu-artists-img3.png" alt="" />
                                            </Link>
                                            <div className="artists-content">
                                        ...
                                        <li>
                                            <Link href="/artists/portfolio" className="artists-img">
                                                <img src="/assets/img/home1/menu-artists-img4.png" alt="" />
                                            </Link>
                                            <div className="artists-content">
                                        ...
                                        <li>
                                            <Link href="/artists/portfolio" className="artists-img">
                                                <img src="/assets/img/home1/menu-artists-img5.png" alt="" />
                                            </Link>
                                            <div className="artists-content">
                                        ...
                                        <li>
                                            <Link href="/artists/portfolio" className="artists-img">
                                                <img src="/assets/img/home1/menu-artists-img6.png" alt="" />
                                            </Link>
                                            <div className="artists-content">
                                    ...
                                    <div className="all-btn d-flex justify-content-center">
                                        <Link href="/artists/portfolio">See All</Link>
                                    </div>
                                </div>
                            </li>
                            <li className="menu-item-has-children" onClick={() => toggleMenu("art")}>
                                <a href="#" className="drop-down">Art Catalog</a>
                                <i className={`bi bi-${state.activeMenu === "art" ? "dash" : "plus"} dropdown-icon"`} />
                                <div className={`mega-menu2  ${state.activeMenu === "art" ? "d-block" : ""}`}>
                                    <ul className="menu-row">
                                        <li className="menu-single-item">
                                            ...
                                            <ul>
                                                <li className={pathname === "/auction" ? "active" : ""}><Link href="/auction">Auction Art</Link></li>
                                                <li className={pathname === "/general-art-grid" ? "active" : ""}><Link href="/general-art-grid">General Art</Link></li>
                                            </ul>
                                        </li>
                                        <li className="menu-single-item">
                                            <div className="menu-title">
                                            ...
                                            <ul>
                                                <li><Link href="/artists/portfolio">Frida Kahlo</Link></li>
                                                <li><Link href="/artists/portfolio">Pablo Picasso</Link></li>
                                                <li><Link href="/artists/portfolio">Leonardo da Vinci</Link></li>
                                                <li><Link href="/artists/portfolio">Gustav Klimt</Link></li>
                                                <li><Link href="/artists/portfolio">Yayoi Kusama</Link></li>
                                                <li><Link href="/artists" className="all-btn"><span>See All</span></Link></li>
                                            </ul>
                                        </li>
                                        <li className="menu-single-item">
                                            <div className="menu-title">
                                            ...
                                            <ul>
                                                <li><Link href="/auction">Painting</Link></li>
                                                <li><Link href="/auction">Sculpture</Link></li>
                                                <li><Link href="/auction">Print</Link></li>
                                                <li><Link href="/auction">Natura</Link></li>
                                                <li><Link href="/auction">Street Art</Link></li>
                                                <li><Link href="/auction" className="all-btn"><span>See All</span></Link></li>
                                            </ul>
                                        </li>
                                        <li className="menu-single-item">
                                            <div className="menu-title">
                                            ...
                                            <ul>
                                                <li><Link href="/auction">Post War</Link></li>
                                                <li><Link href="/auction">Contemporary Art</Link></li>
                                                <li><Link href="/auction">Print and Multiples</Link></li>
                                                <li><Link href="/auction" className="all-btn"><span>See All</span></Link></li>
                                            </ul>
                                        </li>
                                    </ul>
                                    <div className="auction-card-area">
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <div className="auction-card">
                                                    <div className="auction-card-img-wrap">
                                                        <Link href="/auction/details" className="card-img">
                                                            <img src="/assets/img/home1/menu-auction-card-img1.jpg" alt="" />
                                                        </Link>
                                                        <div className="batch">
                                                            <span>Live</span>
                                                        </div>
                                                    ...
                                                    <div className="auction-card-content">
                                                        <h6><Link href="/auction/details">Frida Kahlo Tropical Print</Link></h6>
                                                        <ul>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="auction-card">
                                                    <div className="auction-card-img-wrap">
                                                        <Link href="/auction/details" className="card-img">
                                                            <img src="/assets/img/home1/menu-auction-card-img2.jpg" alt="" />
                                                        </Link>
                                                        <div className="batch">
                                                    ...
                                                    <div className="auction-card-content">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><span>Current Bidding : </span>$280.00</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="search-area d-lg-none d-block">
                            <form>
                                <div className="form-inner">
                    ...
                    <div className="nav-right">
                        <div className="dark-light-switch d-lg-none d-block" onClick={toggleTheme}>
                            {/* <i className="bi bi-brightness-low-fill" /> */}
                            <i
                                className={`bi ${isDarkMode ? "bi-moon-fill" : " bi-brightness-low-fill"
                                    }`}
                            />
                        </div>
