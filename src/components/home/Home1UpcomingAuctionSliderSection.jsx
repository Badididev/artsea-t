      ...
      <div className="container">
        ...
        <div className="upcoming-auction-slider-wrap wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <Link href="/auction/details2" className="card-img">
                          <img src="assets/img/home1/upcoming-auction-img1.jpg" alt="" />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details2">A moment captured in color and form</Link>
                        </h6>
                        <ul>
                          <li><span>Artist : </span>Frida Kahlo</li>
                          <li><span>Current Bidding : </span>$200.00</li>
                        </ul>
                        <Link href="/auction/details2" className="bid-btn btn-hover">
                          <span>Notify Me</span>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <Link href="/auction/details2" className="card-img">
                          <img src="assets/img/home1/upcoming-auction-img2.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="upcoming">UpComing</span>
                        </div>
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details2">Whispers of the Forest Secrets by the
                          Wind</Link></h6>
                        <ul>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <Link href="/auction/details2" className="card-img">
                          <img src="assets/img/home1/upcoming-auction-img3.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="upcoming">UpComing</span>
                        </div>
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details2">The Last Light Echoes of My Youth </Link>
                        </h6>
                        <ul>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <Link href="/auction/details2" className="card-img">
                          <img src="assets/img/home1/upcoming-auction-img4.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="upcoming">UpComing</span>
                        </div>
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details2">Dancing Colors on a Summer Breeze</Link>
                        </h6>
                        <ul>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <Link href="/auction/details2" className="card-img">
                          <img src="assets/img/home1/upcoming-auction-img5.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="upcoming">UpComing</span>
                        </div>
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details2">The Final Rays of Light from My
                          Childhood</Link></h6>
                        <ul>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <Link href="/auction/details2" className="card-img">
                          <img src="assets/img/home1/upcoming-auction-img6.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="upcoming">UpComing</span>
                        </div>
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details2">A brushstroke of serenity in a chaotic
                          world</Link></h6>
                        <ul>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card">
                      <div className="auction-card-img-wrap">
                        <Link href="/auction/details2" className="card-img">
                          <img src="assets/img/home1/upcoming-auction-img7.jpg" alt="" />
                        </Link>
                        <div className="batch">
                          <span className="upcoming">UpComing</span>
                        </div>
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details2">Bright Colors on the Summer Wind</Link>
                        </h6>
                        <ul>
          ...
          <div className="slider-btn-grp">
            <div className="slider-btn upcoming-auction-slider-prev">
              <svg width={10} height={16} viewBox="0 0 10 16" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.735295 8.27932L10 16L4.10428 8.27932L10 0.558823L0.735295 8.27932Z" />
              </svg>
            </div>
            <div className="slider-btn upcoming-auction-slider-next">
              <svg width={10} height={16} viewBox="0 0 10 16" xmlns="http://www.w3.org/2000/svg">
