...
const page = () => {
  return (
    <div>
      <Header1 />
      <div className="breadcrumb-section" style={{ backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.28), rgba(0, 0, 0, 0.28)), url(/assets/img/inner-page/breadcrumb-image.jpg)' }}>
                ...
                <div className="row gy-4">
                  ...
                  <div className="col-lg-5 d-flex justify-content-lg-end">
                    <div className="artist-image">
                      <img src="/assets/img/inner-page/artist-image.jpg" alt="" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row mb-35">
                  <div className="nav-area">
                    <div className="col-lg-12 d-flex justify-content-center">
                      <ul className="nav nav-tabs2" id="myTab5" role="tablist">
                        <li className="nav-item" role="presentation">
                          <button className="nav-link active" id="artworks-tab" data-bs-toggle="tab" data-bs-target="#artworks" type="button" role="tab" aria-controls="artworks" aria-selected="false" tabIndex={-1}>Artworks</button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="biography-tab" data-bs-toggle="tab" data-bs-target="#biography" type="button" role="tab" aria-controls="biography" aria-selected="false" tabIndex={-1}>Biography</button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="awards-tab" data-bs-toggle="tab" data-bs-target="#awards" type="button" role="tab" aria-controls="awards" aria-selected="false" tabIndex={-1}>Awards</button>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="row ">
                  <div className="col-lg-12">
                    <div className="tab-content" id="myTabContent5">
                      <div className="tab-pane fade show active" id="artworks" role="tabpanel">
                        <div className="row justify-content-center gy-4">
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image.png" alt="" />
                                </Link>
                                <div className="batch">
                                  <span>Live</span>
                                </div>
                              ...
                              <div className="auction-card-content">
                                <h6><Link href="/auction/details">Frida Kahlo Tropical
                                  Print</Link>
                                </h6>
                                <ul>
                          ...
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image2.png" alt="" />
                                </Link>
                                <div className="batch">
                              ...
                              <div className="auction-card-content">
                                <h6><Link href="/auction/details">Me &amp; My Parrots</Link>
                                </h6>
                                <ul>
                                  <li><span>Artist : </span>Frida Kahlo</li>
                                </ul>
                          ...
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image3.png" alt="" />
                                </Link>
                                <div className="batch">
                              ...
                              <div className="auction-card-content">
                                <h6><Link href="/auction/details">The Two Fridas</Link>
                                </h6>
                                <ul>
                                  <li><span>Artist : </span>Frida Kahlo</li>
                                  <li><span>Current Bidding : </span>$600.00</li>
                                </ul>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image4.png" alt="" />
                                </Link>
                                <div className="batch">
                                  <span className="sold-out">Sold Out</span>
                                </div>
                              ...
                              <div className="auction-card-content">
                                <h6><Link href="/auction/details">Memory The Heart</Link>
                                </h6>
                                <ul>
                                  <li><span>Artist : </span>Frida Kahlo</li>
                                </ul>
                          ...
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image5.png" alt="" />
                                </Link>
                                <div className="batch">
                                  <span className="sold-out">Sold Out</span>
                                </div>
                              ...
                              <div className="auction-card-content">
                                <h6><Link href="/auction/details">Self-Portrait</Link>
                                </h6>
                                <ul>
                                  <li><span>Artist : </span>Frida Kahlo</li>
                                </ul>
                          ...
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image6.png" alt="" />
                                </Link>
                                <div className="batch">
                                  <span>Live</span>
                                </div>
                              ...
                              <div className="auction-card-content">
                                <h6><Link href="/auction/details">Self-Portrait With
                                  Birds</Link>
                                </h6>
                                <ul>
                                  <li><span>Artist : </span>Frida Kahlo</li>
                                  <li><span>Current Bidding : </span>$550.00</li>
                                </ul>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image7.png" alt="" />
                                </Link>
                                <div className="batch">
                                  <span className="upcoming">UpComing</span>
                                </div>
                              ...
                              <div className="auction-card-content">
                                ...
                                <ul>
                                  <li><span>Artist : </span>Frida Kahlo</li>
                                  <li><span>Bidding will Started : </span>$200.00</li>
                                </ul>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image8.png" alt="" />
                                </Link>
                                <div className="batch">
                                  <span className="sold-out">Sold Out</span>
                                </div>
                          ...
                          <div className="col-lg-4 col-md-6">
                            <div className="auction-card sidebar-card">
                              <div className="auction-card-img-wrap">
                                <Link href="/general-art-details" className="card-img">
                                  <img src="/assets/img/inner-page/sidebar-image9.png" alt="" />
                                </Link>
                                <div className="batch">
                                  <span>Live</span>
                                </div>
                              ...
                              <div className="auction-card-content">
                                <h6><Link href="/auction/details">Frida Kahlo Love’s</Link>
                                </h6>
                                <ul>
                                  <li><span>Artist : </span>Frida Kahlo</li>
                                  <li><span>Current Bidding : </span>$950.00</li>
                                </ul>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="tab-pane" id="biography" role="tabpanel">
                        <div className="row">
                          <div className="col-lg-8">
                            <div className="biography-section">
                              <p className="biography-top-text">Frida Kahlo (1907-1954) was a Mexican
                                painter known for her
                                distinctive, vibrant self-portraits and her deeply personal and
                                symbolic art. Here are some key points about her life and work:
                              </p>
                              <div className="biography-card">
                                <h4>Early Life and Background</h4>
                                <p><span>Birth:</span> Born on July 6, 1907, in Coyoacán, Mexico
                                  City.</p>
                                <p><span>Health Issues:</span> Experienced polio as a child and
                                  a severe bus accident at age 18, which led to numerous
                                  surgeries and chronic pain.</p>
                              </div>
                              <div className="biography-card">
                                <h4>Artistic Career</h4>
                                <p><span>Style:</span> Known for her surrealist and symbolic
                                  style, her work often includes elements of Mexican folk art
                                  and indigenous culture.</p>
                                <p><span>Notable Works:</span> Some of her most famous works
                                  include "The Two Fridas" (1939), "Self-Portrait with Thorn
                                  Necklace and Hummingbird" (1940), and "The Broken Column"
                                  (1944)</p>
                              </div>
                              <div className="biography-card">
                                <h4>Personal Life</h4>
                                <p><span>Marriage:</span> Married fellow artist Diego Rivera in
                                  1931. Their tumultuous relationship and its impact on her
                                  art were significant aspects of her life.</p>
                                <p><span>Political Activism:</span> Actively involved in leftist
                                  politics and supported the Mexican Communist Party.</p>
                              </div>
                              <div className="biography-card">
                                <h4>Legacy</h4>
                                <p><span>Influence:</span> Kahlo’s work has had a lasting impact
                                  on art, particularly in terms of how women’s experiences and
                                  identities are represented.</p>
                                <p><span>Museum:</span> The Frida Kahlo Museum, also known as La
                                  Casa Azul (The Blue House), is located in her former home in
                                  Coyoacán and is dedicated to her life and work</p>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-4">
                            <div className="biography-right-section">
                              <div className="biography-right-content">
                                <h6>Nationality</h6>
                                <p>Mexican artist</p>
                              </div>
                              <div className="biography-right-content">
                                ...
                                <p>Self Portraits, Mexican Culture and Folklore, Surrealism,
                                  Politics and Social Issues, Nature and Animals
                                </p>
                              </div>
                              <div className="biography-right-content">
                                <h6>Themes</h6>
                      ...
                      <div className="tab-pane" id="awards" role="tabpanel">
                        <div className="awards-section">
                          <p>Frida Kahlo did not receive many formal awards during her lifetime, as
                            her work was not widely recognized until after her death. However, she
                            did receive some notable recognition or award:</p>
                          <ul className="awards-list">
                            <li>
                              <div className="content">
                                <span>1946</span>
                                <h4>National Prize of Arts and Sciences(Mexico)</h4>
                                <p>Site Of The Day</p>
                              </div>
                              <div className="button-area">
                            ...
                            <li>
                              <div className="content">
                                <span>1946</span>
                                <h4>Praemium Imperiale (Japan)</h4>
                                <p>Site Of The Month</p>
                              </div>
                              <div className="button-area">
                                <a href="#" className="icon">
