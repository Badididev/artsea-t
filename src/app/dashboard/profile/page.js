        ...
        <div className="dashboard-content-wrap">
          <div className="dashboard-profile-content">
            <div className="single-content">
              <h5>Basic Info</h5>
              <div className="author-area text-center">
                <div className="author-image">
                  <img src="/assets/img/inner-page/author-profile-image.png" alt="" />
                  <div className="icon">
                    <svg width={15} height={15} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_1323_1720)">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="form-inner mb-30">
                      ...
                      <input type="text" placeholder="27/08/2025" />
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="form-inner mb-30">
                  ...
                  <div className="col-md-6 mb-30">
                    <div className="form-inner">
                      <label>Country*</label>
                      <SelectComponent placeholder="Country" options={["United Kingdom","Bangladesh","United State"]} />
            ...
            <div className="single-content style-2">
              ...
              <form>
                <div className="row">
                  <div className="col-md-6 mb-30">
                    <div className="form-inner">
                      <label>City * </label>
                      <SelectComponent placeholder="City" options={["Dhaka","Rangpur","Nilphamari"]} />
                  ...
                  <div className="col-md-6 mb-30">
                    <div className="form-inner">
                      <label>State</label>
                      <SelectComponent placeholder="State" options={["Dhaka","Rangpur","Nilphamari"]} />
                  ...
                  <div className="col-md-6 mb-30">
                    <div className="form-inner">
                      <label>Country *</label>
                      <SelectComponent placeholder="sorting" options={["United Kingdom","Bangladesh","United State"]} />
                    </div>
                  </div>
            ...
            <div className="single-content style-2">
              ...
              <form>
                ...
                <div className="form-inner style-2">
                  <button type="submit" className="primary-btn2 btn-hover">
                    <span>Update Profile</span>
                    <strong style={{ top: '48px', left: '69.5px' }} />
                  </button>
                  <button type="submit" className="primary-btn1 btn-hover style-2">
                    <span>Cancel</span>
                    <strong style={{ top: '48px', left: '69.5px' }} />
                  </button>
                </div>
