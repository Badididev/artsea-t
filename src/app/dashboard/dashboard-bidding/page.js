                                ...
                                <div className="dashboard-order-content">
                                    <div className="dashboard-order-table">
                                        <div className="dashboard-top-area">
                                            <h4>All Bidding Items</h4>
                                            <div className="category-area d-lg-flex d-none active">
                                            <SelectComponent placeholder="sorting" options={["Sort by Status","Sort by Product title"]} />
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td data-label="Status"><span className="green-color">win</span></td>
