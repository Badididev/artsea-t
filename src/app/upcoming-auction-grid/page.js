                  ...
                  <div className="auction-card-top-area">
                    ...
                    <div className="right-content">
                      <div className="category-area d-lg-flex d-none active">
                        <SelectComponent options={["sorting", "latest", "Best selling", "Price Low to high", "Price high to low"]} placeholder={"sorting"} />
                      </div>
                ...
                <div className="row gy-4">
                  <div className="col-lg-4 col-md-6 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="auction-card general-art">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details">Bright Colors on the Summer Wind</Link></h6>
                        <ul>
                  ...
                  <div className="col-lg-4 col-md-6 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="auction-card general-art">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details">Sighs of Isolation from a Lost City</Link></h6>
                        <ul>
                  ...
                  <div className="col-lg-4 col-md-6 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="auction-card general-art">
                      ...
                      <div className="auction-card-content">
                        <h6><Link href="/auction/details">The Final Rays of Light from My Childhood</Link>
                        </h6>
                        <ul>
...
export default UpcommingAucitonPage